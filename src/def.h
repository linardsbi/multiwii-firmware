...
/**************************   atmega328P (Promini)  ************************************/
#if defined(PROMINI)
  #include "boards/pins_promini.h"
#endif

/**************************  atmega32u4 (Promicro)  ***********************************/
#if defined(PROMICRO)
  #include "boards/pins_promicro.h"
#endif

/**************************  all the Mega types  ***********************************/
#if defined(MEGA)
  #include "boards/pins_mega.h"
#endif
...
// note: that may be moved to the IMU Orientations because this are board defines .. not Proc
  ...
  #include "boards/pins_mongoose.h"
#endif


/**************************  esp8266  ***********************************/
#if defined(__ESP8266)
  #include "boards/pins_esp8266.h"
#endif

/**************************  Raspberry pi pico  ***********************************/
#if defined(PI_PICO)
  #include "boards/pins_pico.h"
#endif
