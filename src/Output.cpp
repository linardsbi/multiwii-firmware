...
#endif
#if defined(PI_PICO)
  uint8_t PWM_PIN[8] = {14,15,16,17,19,20,21,22};      //for a quad+: rear,right,left,front   //+ for y6: 7:under right  8:under left
#endif
/**************************************************************************************/
...
#if defined(SERVO_1_HIGH) && !defined(A32U4_4_HW_PWM_SERVOS) && defined(__AVR)
